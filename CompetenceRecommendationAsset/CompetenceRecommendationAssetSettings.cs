namespace CompetenceRecommendationAssetNameSpace
{
    ...
    /// </summary>
    public class CompetenceRecommendationAssetSettings : BaseSettings
    {
        #region Constructors

        /// <summary>
        /// Initializes a new instance of the CompetenceRecommendationAsset.AssetSettings class.
        /// </summary>
        public CompetenceRecommendationAssetSettings()
            : base()
        {
