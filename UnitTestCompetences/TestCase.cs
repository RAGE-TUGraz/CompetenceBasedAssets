...
namespace UnitTestCompetences
{
    ...
    public class TestCase
    {
        ...
        public void Initialize()
        {
            ...
            {
#warning change bridge implementation (in TestCase.cs) for testing (IDataStoragePath and ILog - logging behaviour)
                //Adding the bridge
        ...
        /// </summary>
        [TestMethod]
        private void setTestEnvironment23(string xi, string minonecompetence, string maxonelevel)
        {
            //create DomainModel
            DomainModel dm = new DomainModel();
            //Competences
